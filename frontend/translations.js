export const translations = {
    en: {
        ...
        CHART_PLACEHOLDER: "Select a ticker from tracked assets to display its live chart.",
    ...
    es: {
        ...
        CHART_PLACEHOLDER: "Seleccione un par de los activos rastreados para mostrar su gráfico en vivo.",
